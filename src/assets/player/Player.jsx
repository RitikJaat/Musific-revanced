      ...
      <div className="z-30 flex flex-col w-40 h-20 transition-all duration-300 bg-[#1b233d] shadow-md group-hover/he:h-40 group-hover/he:w-72 rounded-2xl shadow-zinc-400">
        <div className="flex flex-row w-full h-0 group-hover/he:h-20">
          ...
          <div className="flex flex-col justify-center w-full pl-3 -ml-24 overflow-hidden group-hover/he:-ml-3 text-nowrap">
            ...
            <p className="text-[rgba(170,222,243,0.721)]">Singer &amp; artist</p>
          </div>
        </div>
        <div className="flex flex-row mx-3 mt-3 bg-indigo-100 rounded-md min-h-4 group-hover/he:mt-0">
          <span className="hidden pl-3 text-sm text-[rgba(170,222,243,0.721)] group-hover/he:inline-block">0:00</span>
          ...
          <span className="hidden pr-3 text-sm text-[rgba(170,222,243,0.721)] group-hover/he:inline-block">3:45</span>
        </div>
